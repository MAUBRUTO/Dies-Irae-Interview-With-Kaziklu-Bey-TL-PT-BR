...
Tradução de Ikabey do japonês para Português Brasileiro. Compatível com a versão da Steam.
 ...
 - Preserva: **Narração em 3ª pessoa** (Por exemplo na luta contra Matusalém na neve, luta em Katyn, etc.)
 - Preserva: **Termos relacionados a personagens** (`Ougon, Nayuta, Suigin, Shinga, etc.`)
...
# Meio de Instalação
Estarei disponibilizando o [Instalador necessário](https://github.com/MAUBRUTO/Dies-Irae-Interview-With-Kaziklu-Bey-TL-PT-BR/releases/latest/download/Ikabey-Traducao-PT-BR.exe) referente às 12 horas de aplicação do jogo e distribuição da tradução para você aplicar no seu próprio jogo atual. Dentro do próprio Instalador já referido, está explicado tudo o que se deve fazer para mexer na tradução, porém irei dar um breve resumo:
